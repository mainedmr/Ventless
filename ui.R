        ...
        tabsetPanel(type = "tabs",
                    ...
                    tabPanel("Participation",
                             ...
                             tags$div("Senior Lobster Biologist", tags$br(),
                                      ...
                                      "P.O. Box 8, 194 Mckown Point Road", tags$br(),
                                      "West Boothbay Harbor, ME 04575", tags$br(),
                                      "Email: Kathleen.Reardon@Maine.gov", tags$br(),
                                      "Cell: (207) 350-7440"),
                             h4("Matt Davis"),
                             tags$div("Coordinator, Ventless Trap Survey & Lobster at-Sea Sampling", tags$br(),
                                      "Maine Department of Marine Resources", tags$br(),
                                      "P.O. Box 8, 194 Mckown Point Road", tags$br(),
                                      "West Boothbay Harbor, ME 04575", tags$br(),
                                      "Email: Matthew.M.Davis@Maine.gov", tags$br(),
                                      "Cell: (207) 592-2339"),
                             h2("Thank you!"),
                             img(src=Picture1)
                    ),
                    tabPanel("Downloads", 
                             ...
                             tags$div("Matt Davis", tags$br(),
                                      "Ventless Trap Survey & at-Sea Sampling Coordinator", tags$br(),
                                      "Maine Department of Marine Resources", tags$br(),
                                      "P.O. Box 8, 194 Mckown Point Road", tags$br(),
                                      "West Boothbay Harbor, ME 04575", tags$br(),
